...
function SellerAiProduct() {
  ...
  const handleGenerateContent = async () => {
    ...
    if (!description.trim()) {
      setError(
        "Please describe the product first."
      );
      return;
    }
...
titanium body, 5G smartphone with a
powerful camera and USB-C charging.
            "
            rows="7"
            className="
              w-full
          ...
          <p className="
            ...
            text-gray-500
          ">
            Give AI as much information as
            possible about the product. It will
            create the product title,
            description, features and other
            information.
          </p>
        ...
        {generatedProduct && (
          ...
          ">
            ...
            {generatedProduct.features &&
              generatedProduct.features.length >
                0 && (
...
export default SellerAiProduct;